...
function NoOrderIcon(props: SvgProps) {
  return (
    <Svg width={176} height={176} viewBox="0 0 176 176" fill="none" {...props}>
      ...
      />
      <Path
        d="M97.956 104.795L88 94.839l-9.956 9.956-3.319-3.319 9.956-9.956-9.956-9.956 3.319-3.319L88 88.201l9.956-9.956 3.319 3.32-9.956 9.955 9.956 9.956-3.319 3.319z"
        fill="#fff"
      />
      <Path
        d="M103.253 126.72H72.747a3.52 3.52 0 100 7.04h30.506a3.52 3.52 0 000-7.04zM113.813 140.8H62.186a3.52 3.52 0 000 7.04h51.627a3.52 3.52 0 000-7.04z"
        fill="#ECEAFD"
      />
    </Svg>
  );
